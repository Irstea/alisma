...
\item [lambert\_x\_aval et lambert\_y\_amont] : coordonnées Lambert du point aval (recommanded)
...
\begin{description}
\item[url] : adresse du site web
\item [resourceIbmrCalc] : chemin d'accès au programme de calcul
\item [indicator] : code de l'indicateur
\item [version] : version utilisée pour le calcul de l'indicateur
\item [proxyEnabled] : si à \textit{true}, la connexion est réalisée en utilisant un proxy d'entreprise
