...
public class Unite_releves extends DbObject {
	...
	public Unite_releves() {
		...
		setNumericList(new String [] {"pc_UR", "longueur_UR", "largeur_UR", "pc_vegetalisation",
				"ch_lentique","pl_lentique", "mouille", "fosse_dissipation", "ch_lotique", 
				"radier", "cascade", "pl_courant", "rapide", 
				"p1", "p2", "p3", "p4", "p5", "v1", "v2", "v3", "v4", "v5",
				"tres_ombrage", "ombrage", "peu_ombrage", "eclaire", "tres_eclaire",
				"vase_limons", "terre_marne_tourbe", "cailloux_pierres", "blocs_dalles", "sable_graviers",
				"racines", "debris_org", "artificiel",
				"pc_heterot", "pc_algues", "pc_bryo", "pc_lichen", "pc_phanero", "pc_flottante",
				"pc_immerg", "pc_helophyte", "autreTypeClass",
				"id_op_controle", "numUR",
				"type_ur_id", "periphyton_id", "facies_id", "facies_autre_type_id"});
		/*
	...
	/**
	 * Retourne la liste des ur correspondant a une operation,
	 * avec les tables de parametre associees
	 * @param key
	 * @return
	 */
